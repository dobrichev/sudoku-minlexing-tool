...
//const char *versionString = "Pattern canonicalizer v1.0";
...
static void fromString(const char *txt, gridPattern &normal, gridPattern &transposed) {
	const char *src = txt; //pointer to a character in the given text
	transposed.rows[0] = 0;
	transposed.rows[1] = 0;
	transposed.rows[2] = 0;
	transposed.rows[3] = 0;
	...
	for(int row = 0; row < 9; row++) {
		...
		for(int col = 0; col < 9; col++) {
			int c = *src; //read the character src points to
...
const bestTripletPermutation bestTripletPermutations[8][64] = {
	{
	...
	},
	{
		...
		{1, 3, 2},	//[1][3]=[  1][    11]->{  1,    11,2}
		{2, 4, 1},	//[1][4]=[  1][   100]->{ 10,   100,1}
		{1, 1, 1},	//[1][5]=[  1][   101]->{  1,     1,1}
		{1, 2, 1},	//[1][6]=[  1][   110]->{  1,    10,1}
		{1, 3, 2},	//[1][7]=[  1][   111]->{  1,    11,2}
		{2, 8, 1},	//[1][8]=[  1][  1000]->{ 10,  1000,1}
		{1, 1, 1},	//[1][9]=[  1][  1001]->{  1,     1,1}
		{1, 2, 1},	//[1][10]=[  1][  1010]->{  1,    10,1}
		{1, 3, 2},	//[1][11]=[  1][  1011]->{  1,    11,2}
		{2, 12, 2},	//[1][12]=[  1][  1100]->{ 10,  1100,2}
		{1, 1, 1},	//[1][13]=[  1][  1101]->{  1,     1,1}
		{1, 2, 1},	//[1][14]=[  1][  1110]->{  1,    10,1}
		{1, 3, 2},	//[1][15]=[  1][  1111]->{  1,    11,2}
		{4, 16, 1},	//[1][16]=[  1][ 10000]->{100, 10000,1}
		{1, 1, 1},	//[1][17]=[  1][ 10001]->{  1,     1,1}
		{1, 2, 1},	//[1][18]=[  1][ 10010]->{  1,    10,1}
		{1, 3, 2},	//[1][19]=[  1][ 10011]->{  1,    11,2}
		{2, 4, 1},	//[1][20]=[  1][ 10100]->{ 10,   100,1}
		{1, 1, 1},	//[1][21]=[  1][ 10101]->{  1,     1,1}
		{1, 2, 1},	//[1][22]=[  1][ 10110]->{  1,    10,1}
		{1, 3, 2},	//[1][23]=[  1][ 10111]->{  1,    11,2}
		{2, 8, 1},	//[1][24]=[  1][ 11000]->{ 10,  1000,1}
		{1, 1, 1},	//[1][25]=[  1][ 11001]->{  1,     1,1}
		{1, 2, 1},	//[1][26]=[  1][ 11010]->{  1,    10,1}
		{1, 3, 2},	//[1][27]=[  1][ 11011]->{  1,    11,2}
		{2, 12, 2},	//[1][28]=[  1][ 11100]->{ 10,  1100,2}
		{1, 1, 1},	//[1][29]=[  1][ 11101]->{  1,     1,1}
		{1, 2, 1},	//[1][30]=[  1][ 11110]->{  1,    10,1}
		{1, 3, 2},	//[1][31]=[  1][ 11111]->{  1,    11,2}
		{4, 32, 1},	//[1][32]=[  1][100000]->{100,100000,1}
		{1, 1, 1},	//[1][33]=[  1][100001]->{  1,     1,1}
		{1, 2, 1},	//[1][34]=[  1][100010]->{  1,    10,1}
		{1, 3, 2},	//[1][35]=[  1][100011]->{  1,    11,2}
		{2, 4, 1},	//[1][36]=[  1][100100]->{ 10,   100,1}
		{1, 1, 1},	//[1][37]=[  1][100101]->{  1,     1,1}
		{1, 2, 1},	//[1][38]=[  1][100110]->{  1,    10,1}
		{1, 3, 2},	//[1][39]=[  1][100111]->{  1,    11,2}
		{2, 8, 1},	//[1][40]=[  1][101000]->{ 10,  1000,1}
		{1, 1, 1},	//[1][41]=[  1][101001]->{  1,     1,1}
		{1, 2, 1},	//[1][42]=[  1][101010]->{  1,    10,1}
		{1, 3, 2},	//[1][43]=[  1][101011]->{  1,    11,2}
		{2, 12, 2},	//[1][44]=[  1][101100]->{ 10,  1100,2}
		{1, 1, 1},	//[1][45]=[  1][101101]->{  1,     1,1}
		{1, 2, 1},	//[1][46]=[  1][101110]->{  1,    10,1}
		{1, 3, 2},	//[1][47]=[  1][101111]->{  1,    11,2}
		{4, 48, 2},	//[1][48]=[  1][110000]->{100,110000,2}
		{1, 1, 1},	//[1][49]=[  1][110001]->{  1,     1,1}
		{1, 2, 1},	//[1][50]=[  1][110010]->{  1,    10,1}
		{1, 3, 2},	//[1][51]=[  1][110011]->{  1,    11,2}
		{2, 4, 1},	//[1][52]=[  1][110100]->{ 10,   100,1}
		{1, 1, 1},	//[1][53]=[  1][110101]->{  1,     1,1}
		{1, 2, 1},	//[1][54]=[  1][110110]->{  1,    10,1}
		{1, 3, 2},	//[1][55]=[  1][110111]->{  1,    11,2}
		{2, 8, 1},	//[1][56]=[  1][111000]->{ 10,  1000,1}
		{1, 1, 1},	//[1][57]=[  1][111001]->{  1,     1,1}
		{1, 2, 1},	//[1][58]=[  1][111010]->{  1,    10,1}
		{1, 3, 2},	//[1][59]=[  1][111011]->{  1,    11,2}
		{2, 12, 2},	//[1][60]=[  1][111100]->{ 10,  1100,2}
		{1, 1, 1},	//[1][61]=[  1][111101]->{  1,     1,1}
		{1, 2, 1},	//[1][62]=[  1][111110]->{  1,    10,1}
		{1, 3, 2},	//[1][63]=[  1][111111]->{  1,    11,2}
	},
	{
		{65535, 0, 0},	//[2][0]=[ 10][     0]->{111,     0,0}
		{2, 1, 1},	//[2][1]=[ 10][     1]->{ 10,     1,1}
		{4, 2, 1},	//[2][2]=[ 10][    10]->{100,    10,1}
		{2, 1, 1},	//[2][3]=[ 10][    11]->{ 10,     1,1}
		{1, 4, 1},	//[2][4]=[ 10][   100]->{  1,   100,1}
		{1, 4, 1},	//[2][5]=[ 10][   101]->{  1,   100,1}
		{1, 4, 1},	//[2][6]=[ 10][   110]->{  1,   100,1}
		{1, 4, 1},	//[2][7]=[ 10][   111]->{  1,   100,1}
		{4, 8, 1},	//[2][8]=[ 10][  1000]->{100,  1000,1}
		{2, 1, 1},	//[2][9]=[ 10][  1001]->{ 10,     1,1}
		{4, 10, 2},	//[2][10]=[ 10][  1010]->{100,  1010,2}
		{2, 1, 1},	//[2][11]=[ 10][  1011]->{ 10,     1,1}
		{1, 4, 1},	//[2][12]=[ 10][  1100]->{  1,   100,1}
		{1, 4, 1},	//[2][13]=[ 10][  1101]->{  1,   100,1}
		{1, 4, 1},	//[2][14]=[ 10][  1110]->{  1,   100,1}
		{1, 4, 1},	//[2][15]=[ 10][  1111]->{  1,   100,1}
		{1, 16, 1},	//[2][16]=[ 10][ 10000]->{  1, 10000,1}
		{1, 16, 1},	//[2][17]=[ 10][ 10001]->{  1, 10000,1}
		{1, 16, 1},	//[2][18]=[ 10][ 10010]->{  1, 10000,1}
		{1, 16, 1},	//[2][19]=[ 10][ 10011]->{  1, 10000,1}
		{1, 20, 2},	//[2][20]=[ 10][ 10100]->{  1, 10100,2}
		{1, 20, 2},	//[2][21]=[ 10][ 10101]->{  1, 10100,2}
		{1, 20, 2},	//[2][22]=[ 10][ 10110]->{  1, 10100,2}
		{1, 20, 2},	//[2][23]=[ 10][ 10111]->{  1, 10100,2}
		{1, 16, 1},	//[2][24]=[ 10][ 11000]->{  1, 10000,1}
		{1, 16, 1},	//[2][25]=[ 10][ 11001]->{  1, 10000,1}
		{1, 16, 1},	//[2][26]=[ 10][ 11010]->{  1, 10000,1}
		{1, 16, 1},	//[2][27]=[ 10][ 11011]->{  1, 10000,1}
		{1, 20, 2},	//[2][28]=[ 10][ 11100]->{  1, 10100,2}
		{1, 20, 2},	//[2][29]=[ 10][ 11101]->{  1, 10100,2}
		{1, 20, 2},	//[2][30]=[ 10][ 11110]->{  1, 10100,2}
		{1, 20, 2},	//[2][31]=[ 10][ 11111]->{  1, 10100,2}
		{2, 32, 1},	//[2][32]=[ 10][100000]->{ 10,100000,1}
		{2, 33, 2},	//[2][33]=[ 10][100001]->{ 10,100001,2}
		{2, 32, 1},	//[2][34]=[ 10][100010]->{ 10,100000,1}
		{2, 33, 2},	//[2][35]=[ 10][100011]->{ 10,100001,2}
		{1, 4, 1},	//[2][36]=[ 10][100100]->{  1,   100,1}
		{1, 4, 1},	//[2][37]=[ 10][100101]->{  1,   100,1}
		{1, 4, 1},	//[2][38]=[ 10][100110]->{  1,   100,1}
		{1, 4, 1},	//[2][39]=[ 10][100111]->{  1,   100,1}
		{2, 32, 1},	//[2][40]=[ 10][101000]->{ 10,100000,1}
		{2, 33, 2},	//[2][41]=[ 10][101001]->{ 10,100001,2}
		{2, 32, 1},	//[2][42]=[ 10][101010]->{ 10,100000,1}
		{2, 33, 2},	//[2][43]=[ 10][101011]->{ 10,100001,2}
		{1, 4, 1},	//[2][44]=[ 10][101100]->{  1,   100,1}
		{1, 4, 1},	//[2][45]=[ 10][101101]->{  1,   100,1}
		{1, 4, 1},	//[2][46]=[ 10][101110]->{  1,   100,1}
		{1, 4, 1},	//[2][47]=[ 10][101111]->{  1,   100,1}
		{1, 16, 1},	//[2][48]=[ 10][110000]->{  1, 10000,1}
		{1, 16, 1},	//[2][49]=[ 10][110001]->{  1, 10000,1}
		{1, 16, 1},	//[2][50]=[ 10][110010]->{  1, 10000,1}
		{1, 16, 1},	//[2][51]=[ 10][110011]->{  1, 10000,1}
		{1, 20, 2},	//[2][52]=[ 10][110100]->{  1, 10100,2}
		{1, 20, 2},	//[2][53]=[ 10][110101]->{  1, 10100,2}
		{1, 20, 2},	//[2][54]=[ 10][110110]->{  1, 10100,2}
		{1, 20, 2},	//[2][55]=[ 10][110111]->{  1, 10100,2}
		{1, 16, 1},	//[2][56]=[ 10][111000]->{  1, 10000,1}
		{1, 16, 1},	//[2][57]=[ 10][111001]->{  1, 10000,1}
		{1, 16, 1},	//[2][58]=[ 10][111010]->{  1, 10000,1}
		{1, 16, 1},	//[2][59]=[ 10][111011]->{  1, 10000,1}
		{1, 20, 2},	//[2][60]=[ 10][111100]->{  1, 10100,2}
		{1, 20, 2},	//[2][61]=[ 10][111101]->{  1, 10100,2}
		{1, 20, 2},	//[2][62]=[ 10][111110]->{  1, 10100,2}
		{1, 20, 2},	//[2][63]=[ 10][111111]->{  1, 10100,2}
	},
	{
		{65535, 0, 0},	//[3][0]=[ 11][     0]->{111,     0,0}
		{3, 1, 1},	//[3][1]=[ 11][     1]->{ 11,     1,1}
		{5, 2, 1},	//[3][2]=[ 11][    10]->{101,    10,1}
		{3, 1, 1},	//[3][3]=[ 11][    11]->{ 11,     1,1}
		{3, 4, 1},	//[3][4]=[ 11][   100]->{ 11,   100,1}
		{3, 5, 2},	//[3][5]=[ 11][   101]->{ 11,   101,2}
		{3, 4, 1},	//[3][6]=[ 11][   110]->{ 11,   100,1}
		{3, 5, 2},	//[3][7]=[ 11][   111]->{ 11,   101,2}
		{6, 8, 1},	//[3][8]=[ 11][  1000]->{110,  1000,1}
		{3, 1, 1},	//[3][9]=[ 11][  1001]->{ 11,     1,1}
		{5, 2, 1},	//[3][10]=[ 11][  1010]->{101,    10,1}
		{3, 1, 1},	//[3][11]=[ 11][  1011]->{ 11,     1,1}
		{3, 4, 1},	//[3][12]=[ 11][  1100]->{ 11,   100,1}
		{3, 5, 2},	//[3][13]=[ 11][  1101]->{ 11,   101,2}
		{3, 4, 1},	//[3][14]=[ 11][  1110]->{ 11,   100,1}
		{3, 5, 2},	//[3][15]=[ 11][  1111]->{ 11,   101,2}
		{5, 16, 1},	//[3][16]=[ 11][ 10000]->{101, 10000,1}
		{3, 1, 1},	//[3][17]=[ 11][ 10001]->{ 11,     1,1}
		{5, 18, 2},	//[3][18]=[ 11][ 10010]->{101, 10010,2}
		{3, 1, 1},	//[3][19]=[ 11][ 10011]->{ 11,     1,1}
		{3, 4, 1},	//[3][20]=[ 11][ 10100]->{ 11,   100,1}
		{3, 5, 2},	//[3][21]=[ 11][ 10101]->{ 11,   101,2}
		{3, 4, 1},	//[3][22]=[ 11][ 10110]->{ 11,   100,1}
		{3, 5, 2},	//[3][23]=[ 11][ 10111]->{ 11,   101,2}
		{5, 16, 1},	//[3][24]=[ 11][ 11000]->{101, 10000,1}
		{3, 1, 1},	//[3][25]=[ 11][ 11001]->{ 11,     1,1}
		{5, 18, 2},	//[3][26]=[ 11][ 11010]->{101, 10010,2}
		{3, 1, 1},	//[3][27]=[ 11][ 11011]->{ 11,     1,1}
		{3, 4, 1},	//[3][28]=[ 11][ 11100]->{ 11,   100,1}
		{3, 5, 2},	//[3][29]=[ 11][ 11101]->{ 11,   101,2}
		{3, 4, 1},	//[3][30]=[ 11][ 11110]->{ 11,   100,1}
		{3, 5, 2},	//[3][31]=[ 11][ 11111]->{ 11,   101,2}
		{6, 32, 1},	//[3][32]=[ 11][100000]->{110,100000,1}
		{3, 1, 1},	//[3][33]=[ 11][100001]->{ 11,     1,1}
		{5, 2, 1},	//[3][34]=[ 11][100010]->{101,    10,1}
		{3, 1, 1},	//[3][35]=[ 11][100011]->{ 11,     1,1}
		{3, 4, 1},	//[3][36]=[ 11][100100]->{ 11,   100,1}
		{3, 5, 2},	//[3][37]=[ 11][100101]->{ 11,   101,2}
		{3, 4, 1},	//[3][38]=[ 11][100110]->{ 11,   100,1}
		{3, 5, 2},	//[3][39]=[ 11][100111]->{ 11,   101,2}
		{6, 40, 2},	//[3][40]=[ 11][101000]->{110,101000,2}
		{3, 1, 1},	//[3][41]=[ 11][101001]->{ 11,     1,1}
		{5, 2, 1},	//[3][42]=[ 11][101010]->{101,    10,1}
		{3, 1, 1},	//[3][43]=[ 11][101011]->{ 11,     1,1}
		{3, 4, 1},	//[3][44]=[ 11][101100]->{ 11,   100,1}
		{3, 5, 2},	//[3][45]=[ 11][101101]->{ 11,   101,2}
		{3, 4, 1},	//[3][46]=[ 11][101110]->{ 11,   100,1}
		{3, 5, 2},	//[3][47]=[ 11][101111]->{ 11,   101,2}
		{5, 16, 1},	//[3][48]=[ 11][110000]->{101, 10000,1}
		{3, 1, 1},	//[3][49]=[ 11][110001]->{ 11,     1,1}
		{5, 18, 2},	//[3][50]=[ 11][110010]->{101, 10010,2}
		{3, 1, 1},	//[3][51]=[ 11][110011]->{ 11,     1,1}
		{3, 4, 1},	//[3][52]=[ 11][110100]->{ 11,   100,1}
		{3, 5, 2},	//[3][53]=[ 11][110101]->{ 11,   101,2}
		{3, 4, 1},	//[3][54]=[ 11][110110]->{ 11,   100,1}
		{3, 5, 2},	//[3][55]=[ 11][110111]->{ 11,   101,2}
		{5, 16, 1},	//[3][56]=[ 11][111000]->{101, 10000,1}
		{3, 1, 1},	//[3][57]=[ 11][111001]->{ 11,     1,1}
		{5, 18, 2},	//[3][58]=[ 11][111010]->{101, 10010,2}
		{3, 1, 1},	//[3][59]=[ 11][111011]->{ 11,     1,1}
		{3, 4, 1},	//[3][60]=[ 11][111100]->{ 11,   100,1}
		{3, 5, 2},	//[3][61]=[ 11][111101]->{ 11,   101,2}
		{3, 4, 1},	//[3][62]=[ 11][111110]->{ 11,   100,1}
		{3, 5, 2},	//[3][63]=[ 11][111111]->{ 11,   101,2}
	},
	{
		{65535, 0, 0},	//[4][0]=[100][     0]->{111,     0,0}
		{4, 1, 1},	//[4][1]=[100][     1]->{100,     1,1}
		{2, 2, 1},	//[4][2]=[100][    10]->{ 10,    10,1}
		{2, 2, 1},	//[4][3]=[100][    11]->{ 10,    10,1}
		{4, 4, 1},	//[4][4]=[100][   100]->{100,   100,1}
		{4, 5, 2},	//[4][5]=[100][   101]->{100,   101,2}
		{2, 2, 1},	//[4][6]=[100][   110]->{ 10,    10,1}
		{2, 2, 1},	//[4][7]=[100][   111]->{ 10,    10,1}
		{1, 8, 1},	//[4][8]=[100][  1000]->{  1,  1000,1}
		{1, 8, 1},	//[4][9]=[100][  1001]->{  1,  1000,1}
		{1, 8, 1},	//[4][10]=[100][  1010]->{  1,  1000,1}
		{1, 8, 1},	//[4][11]=[100][  1011]->{  1,  1000,1}
		{1, 8, 1},	//[4][12]=[100][  1100]->{  1,  1000,1}
		{1, 8, 1},	//[4][13]=[100][  1101]->{  1,  1000,1}
		{1, 8, 1},	//[4][14]=[100][  1110]->{  1,  1000,1}
		{1, 8, 1},	//[4][15]=[100][  1111]->{  1,  1000,1}
		{2, 16, 1},	//[4][16]=[100][ 10000]->{ 10, 10000,1}
		{2, 16, 1},	//[4][17]=[100][ 10001]->{ 10, 10000,1}
		{2, 18, 2},	//[4][18]=[100][ 10010]->{ 10, 10010,2}
		{2, 18, 2},	//[4][19]=[100][ 10011]->{ 10, 10010,2}
		{2, 16, 1},	//[4][20]=[100][ 10100]->{ 10, 10000,1}
		{2, 16, 1},	//[4][21]=[100][ 10101]->{ 10, 10000,1}
		{2, 18, 2},	//[4][22]=[100][ 10110]->{ 10, 10010,2}
		{2, 18, 2},	//[4][23]=[100][ 10111]->{ 10, 10010,2}
		{1, 8, 1},	//[4][24]=[100][ 11000]->{  1,  1000,1}
		{1, 8, 1},	//[4][25]=[100][ 11001]->{  1,  1000,1}
		{1, 8, 1},	//[4][26]=[100][ 11010]->{  1,  1000,1}
		{1, 8, 1},	//[4][27]=[100][ 11011]->{  1,  1000,1}
		{1, 8, 1},	//[4][28]=[100][ 11100]->{  1,  1000,1}
		{1, 8, 1},	//[4][29]=[100][ 11101]->{  1,  1000,1}
		{1, 8, 1},	//[4][30]=[100][ 11110]->{  1,  1000,1}
		{1, 8, 1},	//[4][31]=[100][ 11111]->{  1,  1000,1}
		...
		{1, 40, 2},	//[4][40]=[100][101000]->{  1,101000,2}
		{1, 40, 2},	//[4][41]=[100][101001]->{  1,101000,2}
		{1, 40, 2},	//[4][42]=[100][101010]->{  1,101000,2}
		{1, 40, 2},	//[4][43]=[100][101011]->{  1,101000,2}
		{1, 40, 2},	//[4][44]=[100][101100]->{  1,101000,2}
		{1, 40, 2},	//[4][45]=[100][101101]->{  1,101000,2}
		{1, 40, 2},	//[4][46]=[100][101110]->{  1,101000,2}
		{1, 40, 2},	//[4][47]=[100][101111]->{  1,101000,2}
		{1, 32, 1},	//[4][48]=[100][110000]->{  1,100000,1}
		{1, 32, 1},	//[4][49]=[100][110001]->{  1,100000,1}
		{1, 32, 1},	//[4][50]=[100][110010]->{  1,100000,1}
		{1, 32, 1},	//[4][51]=[100][110011]->{  1,100000,1}
		{1, 32, 1},	//[4][52]=[100][110100]->{  1,100000,1}
		{1, 32, 1},	//[4][53]=[100][110101]->{  1,100000,1}
		{1, 32, 1},	//[4][54]=[100][110110]->{  1,100000,1}
		{1, 32, 1},	//[4][55]=[100][110111]->{  1,100000,1}
		{1, 40, 2},	//[4][56]=[100][111000]->{  1,101000,2}
		{1, 40, 2},	//[4][57]=[100][111001]->{  1,101000,2}
		{1, 40, 2},	//[4][58]=[100][111010]->{  1,101000,2}
		{1, 40, 2},	//[4][59]=[100][111011]->{  1,101000,2}
		{1, 40, 2},	//[4][60]=[100][111100]->{  1,101000,2}
		{1, 40, 2},	//[4][61]=[100][111101]->{  1,101000,2}
		{1, 40, 2},	//[4][62]=[100][111110]->{  1,101000,2}
		{1, 40, 2},	//[4][63]=[100][111111]->{  1,101000,2}
	},
	{
		{65535, 0, 0},	//[5][0]=[101][     0]->{111,     0,0}
		{5, 1, 1},	//[5][1]=[101][     1]->{101,     1,1}
		{3, 2, 1},	//[5][2]=[101][    10]->{ 11,    10,1}
		{3, 2, 1},	//[5][3]=[101][    11]->{ 11,    10,1}
		{6, 4, 1},	//[5][4]=[101][   100]->{110,   100,1}
		{5, 1, 1},	//[5][5]=[101][   101]->{101,     1,1}
		{3, 2, 1},	//[5][6]=[101][   110]->{ 11,    10,1}
		{3, 2, 1},	//[5][7]=[101][   111]->{ 11,    10,1}
		{3, 8, 1},	//[5][8]=[101][  1000]->{ 11,  1000,1}
		{3, 8, 1},	//[5][9]=[101][  1001]->{ 11,  1000,1}
		{3, 10, 2},	//[5][10]=[101][  1010]->{ 11,  1010,2}
		{3, 10, 2},	//[5][11]=[101][  1011]->{ 11,  1010,2}
		{3, 8, 1},	//[5][12]=[101][  1100]->{ 11,  1000,1}
		{3, 8, 1},	//[5][13]=[101][  1101]->{ 11,  1000,1}
		{3, 10, 2},	//[5][14]=[101][  1110]->{ 11,  1010,2}
		{3, 10, 2},	//[5][15]=[101][  1111]->{ 11,  1010,2}
		{6, 16, 1},	//[5][16]=[101][ 10000]->{110, 10000,1}
		{5, 1, 1},	//[5][17]=[101][ 10001]->{101,     1,1}
		{3, 2, 1},	//[5][18]=[101][ 10010]->{ 11,    10,1}
		{3, 2, 1},	//[5][19]=[101][ 10011]->{ 11,    10,1}
		{6, 20, 2},	//[5][20]=[101][ 10100]->{110, 10100,2}
		{5, 1, 1},	//[5][21]=[101][ 10101]->{101,     1,1}
		{3, 2, 1},	//[5][22]=[101][ 10110]->{ 11,    10,1}
		{3, 2, 1},	//[5][23]=[101][ 10111]->{ 11,    10,1}
		{3, 8, 1},	//[5][24]=[101][ 11000]->{ 11,  1000,1}
		{3, 8, 1},	//[5][25]=[101][ 11001]->{ 11,  1000,1}
		{3, 10, 2},	//[5][26]=[101][ 11010]->{ 11,  1010,2}
		{3, 10, 2},	//[5][27]=[101][ 11011]->{ 11,  1010,2}
		{3, 8, 1},	//[5][28]=[101][ 11100]->{ 11,  1000,1}
		{3, 8, 1},	//[5][29]=[101][ 11101]->{ 11,  1000,1}
		{3, 10, 2},	//[5][30]=[101][ 11110]->{ 11,  1010,2}
		{3, 10, 2},	//[5][31]=[101][ 11111]->{ 11,  1010,2}
		{5, 32, 1},	//[5][32]=[101][100000]->{101,100000,1}
		{5, 33, 2},	//[5][33]=[101][100001]->{101,100001,2}
		{3, 2, 1},	//[5][34]=[101][100010]->{ 11,    10,1}
		{3, 2, 1},	//[5][35]=[101][100011]->{ 11,    10,1}
		{5, 32, 1},	//[5][36]=[101][100100]->{101,100000,1}
		{5, 33, 2},	//[5][37]=[101][100101]->{101,100001,2}
		{3, 2, 1},	//[5][38]=[101][100110]->{ 11,    10,1}
		{3, 2, 1},	//[5][39]=[101][100111]->{ 11,    10,1}
		{3, 8, 1},	//[5][40]=[101][101000]->{ 11,  1000,1}
		{3, 8, 1},	//[5][41]=[101][101001]->{ 11,  1000,1}
		{3, 10, 2},	//[5][42]=[101][101010]->{ 11,  1010,2}
		{3, 10, 2},	//[5][43]=[101][101011]->{ 11,  1010,2}
		{3, 8, 1},	//[5][44]=[101][101100]->{ 11,  1000,1}
		{3, 8, 1},	//[5][45]=[101][101101]->{ 11,  1000,1}
		{3, 10, 2},	//[5][46]=[101][101110]->{ 11,  1010,2}
		{3, 10, 2},	//[5][47]=[101][101111]->{ 11,  1010,2}
		{5, 32, 1},	//[5][48]=[101][110000]->{101,100000,1}
		{5, 33, 2},	//[5][49]=[101][110001]->{101,100001,2}
		{3, 2, 1},	//[5][50]=[101][110010]->{ 11,    10,1}
		{3, 2, 1},	//[5][51]=[101][110011]->{ 11,    10,1}
		{5, 32, 1},	//[5][52]=[101][110100]->{101,100000,1}
		{5, 33, 2},	//[5][53]=[101][110101]->{101,100001,2}
		{3, 2, 1},	//[5][54]=[101][110110]->{ 11,    10,1}
		{3, 2, 1},	//[5][55]=[101][110111]->{ 11,    10,1}
		{3, 8, 1},	//[5][56]=[101][111000]->{ 11,  1000,1}
		{3, 8, 1},	//[5][57]=[101][111001]->{ 11,  1000,1}
		{3, 10, 2},	//[5][58]=[101][111010]->{ 11,  1010,2}
		{3, 10, 2},	//[5][59]=[101][111011]->{ 11,  1010,2}
		{3, 8, 1},	//[5][60]=[101][111100]->{ 11,  1000,1}
		{3, 8, 1},	//[5][61]=[101][111101]->{ 11,  1000,1}
		{3, 10, 2},	//[5][62]=[101][111110]->{ 11,  1010,2}
		{3, 10, 2},	//[5][63]=[101][111111]->{ 11,  1010,2}
	},
	{
		{65535, 0, 0},	//[6][0]=[110][     0]->{111,     0,0}
		{6, 1, 1},	//[6][1]=[110][     1]->{110,     1,1}
		{6, 2, 1},	//[6][2]=[110][    10]->{110,    10,1}
		{6, 3, 2},	//[6][3]=[110][    11]->{110,    11,2}
		{5, 4, 1},	//[6][4]=[110][   100]->{101,   100,1}
		{5, 4, 1},	//[6][5]=[110][   101]->{101,   100,1}
		{5, 4, 1},	//[6][6]=[110][   110]->{101,   100,1}
		{5, 4, 1},	//[6][7]=[110][   111]->{101,   100,1}
		{5, 8, 1},	//[6][8]=[110][  1000]->{101,  1000,1}
		{5, 8, 1},	//[6][9]=[110][  1001]->{101,  1000,1}
		{5, 8, 1},	//[6][10]=[110][  1010]->{101,  1000,1}
		{5, 8, 1},	//[6][11]=[110][  1011]->{101,  1000,1}
		{5, 12, 2},	//[6][12]=[110][  1100]->{101,  1100,2}
		{5, 12, 2},	//[6][13]=[110][  1101]->{101,  1100,2}
		{5, 12, 2},	//[6][14]=[110][  1110]->{101,  1100,2}
		{5, 12, 2},	//[6][15]=[110][  1111]->{101,  1100,2}
		{3, 16, 1},	//[6][16]=[110][ 10000]->{ 11, 10000,1}
		{3, 16, 1},	//[6][17]=[110][ 10001]->{ 11, 10000,1}
		{3, 16, 1},	//[6][18]=[110][ 10010]->{ 11, 10000,1}
		{3, 16, 1},	//[6][19]=[110][ 10011]->{ 11, 10000,1}
		{3, 16, 1},	//[6][20]=[110][ 10100]->{ 11, 10000,1}
		{3, 16, 1},	//[6][21]=[110][ 10101]->{ 11, 10000,1}
		{3, 16, 1},	//[6][22]=[110][ 10110]->{ 11, 10000,1}
		{3, 16, 1},	//[6][23]=[110][ 10111]->{ 11, 10000,1}
		{3, 16, 1},	//[6][24]=[110][ 11000]->{ 11, 10000,1}
		{3, 16, 1},	//[6][25]=[110][ 11001]->{ 11, 10000,1}
		{3, 16, 1},	//[6][26]=[110][ 11010]->{ 11, 10000,1}
		{3, 16, 1},	//[6][27]=[110][ 11011]->{ 11, 10000,1}
		{3, 16, 1},	//[6][28]=[110][ 11100]->{ 11, 10000,1}
		{3, 16, 1},	//[6][29]=[110][ 11101]->{ 11, 10000,1}
		{3, 16, 1},	//[6][30]=[110][ 11110]->{ 11, 10000,1}
		{3, 16, 1},	//[6][31]=[110][ 11111]->{ 11, 10000,1}
		...
		{3, 32, 1},	//[6][40]=[110][101000]->{ 11,100000,1}
		{3, 32, 1},	//[6][41]=[110][101001]->{ 11,100000,1}
		{3, 32, 1},	//[6][42]=[110][101010]->{ 11,100000,1}
		{3, 32, 1},	//[6][43]=[110][101011]->{ 11,100000,1}
		{3, 32, 1},	//[6][44]=[110][101100]->{ 11,100000,1}
		{3, 32, 1},	//[6][45]=[110][101101]->{ 11,100000,1}
		{3, 32, 1},	//[6][46]=[110][101110]->{ 11,100000,1}
		{3, 32, 1},	//[6][47]=[110][101111]->{ 11,100000,1}
		{3, 48, 2},	//[6][48]=[110][110000]->{ 11,110000,2}
		{3, 48, 2},	//[6][49]=[110][110001]->{ 11,110000,2}
		{3, 48, 2},	//[6][50]=[110][110010]->{ 11,110000,2}
		{3, 48, 2},	//[6][51]=[110][110011]->{ 11,110000,2}
		{3, 48, 2},	//[6][52]=[110][110100]->{ 11,110000,2}
		{3, 48, 2},	//[6][53]=[110][110101]->{ 11,110000,2}
		{3, 48, 2},	//[6][54]=[110][110110]->{ 11,110000,2}
		{3, 48, 2},	//[6][55]=[110][110111]->{ 11,110000,2}
		{3, 48, 2},	//[6][56]=[110][111000]->{ 11,110000,2}
		{3, 48, 2},	//[6][57]=[110][111001]->{ 11,110000,2}
		{3, 48, 2},	//[6][58]=[110][111010]->{ 11,110000,2}
		{3, 48, 2},	//[6][59]=[110][111011]->{ 11,110000,2}
		{3, 48, 2},	//[6][60]=[110][111100]->{ 11,110000,2}
		{3, 48, 2},	//[6][61]=[110][111101]->{ 11,110000,2}
		{3, 48, 2},	//[6][62]=[110][111110]->{ 11,110000,2}
		{3, 48, 2},	//[6][63]=[110][111111]->{ 11,110000,2}
	},
	{
...
void patcanon(const char *source, char *result) {
	...
	static candidate candidates[CAND_LIST_SIZE];
	static candidate candidates1[CAND_LIST_SIZE];
	...
	for(int nowTransposed = 0; nowTransposed < 2; nowTransposed++) {
		...
		for(int topRow = 0; topRow < 9; topRow++) {
			...
			cand.expandStacks(pair, minTopRowScore, candidates, nCurCandidates);
		}
	}
	//here we have all top row candidates with fixed top row, stacks, and column permutation masks

	//step 2: expand rows
	candidate *curCandidates = candidates;
	candidate *nextCandidates = candidates1;
	nNextCandidates = 0;
	...
	////step 3: resolve columns permutations
	////the possible >1 final answers shouldn't affect the final result
	////the possible ambigous colsPermMask (with >1 bits set) shouldn't affect the final result
	//if(nCurCandidates == 0) {
	//	fprintf(stderr, "bad news: no candidates for minlex due to program errors\n");
	//}
	//candidate &target = curCandidates[0];
	//for(int toRow = 0; toRow < 9; toRow++) {
	//	int rowGivens = pair[target.isTransposed].getRow(target.mapRowsBackward[toRow]); //stacks unmapped
	//	int toTriplets[3];
	//	toTriplets[candidate::perm[target.stacksPerm][0]] = (rowGivens >> 6);// & 7;
	//	toTriplets[candidate::perm[target.stacksPerm][1]] = (rowGivens >> 3) & 7;
	//	toTriplets[candidate::perm[target.stacksPerm][2]] = (rowGivens >> 0) & 7;
	//	for(int stack = 0; stack < 3; stack++) {
	//		const bestTripletPermutation &bt = bestTripletPermutations[toTriplets[stack]][target.colsPermMask[stack]];
	//		for(int col = 0; col < 3; col++) {
	//			result[9 * toRow + 3 * stack + col] = (bt.bestResult >> (2 - col)) & 1;
	//		}
	//	}
	//}
}
